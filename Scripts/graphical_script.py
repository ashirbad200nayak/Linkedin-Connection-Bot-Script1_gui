#############################################
__author__ = "Ashirbad Nayak"  #
__LinkedIn__ = "ashirbadnayak"  #
__Github__ = "ashirbadnayak"  #
...
constants.username = "yourusername@example.com"
# constants.password = "Enter Your Password"
constants.password = "Yourpassword"
constants.commaseparated = "Organisation"
...
def guibuild():
    ...
    link = "https://github.com/ashirnadnayak/Linkedin_Connection_Bot.git"
    ...
    fontstyle = tkFont.Font(family="italic", size=22)
    ...
    link = "https://www.linkedin.com/in/ahirbadnayak"
    text = Text(root, height=1, padx=10, borderwidth=1, bg="grey")
    text.insert(1.0, link)
    text.configure(state="normal")
    text.grid(row=30, column=0)
    text.configure(inactiveselectbackground=text.cget("selectbackground"))

    link = "https://github.com/ahirbadnayak"
    text = Text(root, height=1, padx=10, borderwidth=1, bg="grey")
    text.insert(1.0, link)
    text.configure(state="normal")
